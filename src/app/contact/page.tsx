          ...
          <div className="mx-auto max-w-3xl border-x border-border px-4 pt-16 pb-16">
            ...
            <div className="mb-12 grid gap-4 sm:grid-cols-2">
              <Link
                ...
                className="group flex items-center gap-4 border border-border bg-card p-4 transition-colors hover:bg-accent"
              >
                <div className="flex h-12 w-12 shrink-0 items-center justify-center border border-green-600/30 bg-green-500/10 text-green-600">
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="h-6 w-6"
              ...
              <Link
                ...
                className="group flex items-center gap-4 border border-border bg-card p-4 transition-colors hover:bg-accent"
              >
                <div className="flex h-12 w-12 shrink-0 items-center justify-center border border-accent-orange/30 bg-accent-orange/10 text-accent-orange">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
