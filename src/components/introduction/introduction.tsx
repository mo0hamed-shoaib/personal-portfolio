...
export function Introduction() {
  ...
  return (
    <section className="pt-16 pb-16 px-4">
      <div>
        <div className="flex flex-col gap-8 text-center md:flex-row md:items-start md:gap-12 md:text-left">
          {/* Left column: Avatar + Social links (on desktop) */}
          <div className="flex shrink-0 flex-col items-center gap-6 self-center md:self-start">
            <Avatar src={personal.avatar} alt={`${personal.name} avatar`} />

            {/* Social links + CV - shown below avatar on desktop, below text on mobile */}
          ...
          <div className="flex flex-1 flex-col gap-4">
            ...
            {/* Social links + CV - shown below text on mobile only */}
            <div className="flex flex-col items-center gap-4 md:hidden">
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm font-medium text-muted-foreground underline-offset-4 transition-colors hover:text-foreground hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                View CV
              </Link>
            </div>
