...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/base/files#files" text="Animate UI API Reference - Base UI Files" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/base/files#foldertrigger" text="Animate UI API Reference - Base UI FolderTrigger" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/base/files#folderpanel" text="Animate UI API Reference - Base UI FolderPanel" />
