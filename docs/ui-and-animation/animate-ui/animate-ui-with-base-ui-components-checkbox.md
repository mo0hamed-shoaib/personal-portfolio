...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/base/checkbox#checkbox" text="Animate UI API Reference - Checkbox Primitive" />

<ExternalLink href="https://base-ui.com/react/components/checkbox#root" text="Base UI API Reference - Checkbox.Root" />
</div>
