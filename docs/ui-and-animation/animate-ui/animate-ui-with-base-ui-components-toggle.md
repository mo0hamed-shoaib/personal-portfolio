...
URL: /docs/components/base/toggle
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/base/toggle#toggle" text="Animate UI API Reference - Toggle Primitive" />
