...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/components/base/toggle-group#togglegroup" text="Animate UI API Reference - ToggleGroup" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/components/base/toggle-group#toggle" text="Animate UI API Reference - Toggle" />
